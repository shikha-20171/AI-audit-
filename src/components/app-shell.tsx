    ...
    <main className="px-4 py-4 md:px-8 md:py-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <section className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="glass overflow-hidden rounded-[36px] border border-[var(--line)] p-7 shadow-[0_40px_100px_rgba(16,34,41,0.14)] md:p-10">
            <div className="flex flex-wrap items-center gap-3">
              <span className="rounded-full bg-[#102229] px-4 py-2 font-mono text-xs uppercase tracking-[0.24em] text-[#fff7ef]">
                Free audit
              </span>
              <span className="rounded-full border border-[var(--line-strong)] px-4 py-2 font-mono text-xs uppercase tracking-[0.24em] text-[var(--ink-soft)]">
                No login required
              </span>
            </div>
            <h1 className="mt-8 max-w-3xl text-5xl font-semibold tracking-[-0.05em] md:text-7xl">
              SpendSignal
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-8 text-[var(--ink-soft)] md:text-xl">
          ...
          <aside className="glass rounded-[36px] border border-[var(--line)] p-7 md:p-8">
            ...
            <div className="mt-8 rounded-[28px] border border-[var(--line)] bg-[var(--card-strong)] p-5">
        ...
        <section className="grid gap-6 lg:grid-cols-[1fr_1fr]">
          <section className="glass rounded-[36px] border border-[var(--line)] p-6 md:p-8">
            <div className="flex items-center justify-between gap-4">
              ...
              <button
                ...
                className="rounded-full border border-[var(--line-strong)] px-4 py-2 text-sm font-medium"
              >
                Reset
              </button>
            </div>
            ...
            <div className="mt-7 grid gap-4">
              {toolCatalog.map((tool) => {
                ...
                return (
                  <article
                    key={tool.key}
                    className="rounded-[28px] border border-[var(--line)] bg-[rgba(255,255,255,0.66)] p-5"
                  >
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                      <div>
                        <div className="flex items-center gap-3">
                          <input
                            ...
                            type="checkbox"
                            className="h-5 w-5 rounded border-[var(--line-strong)]"
                          />
                      ...
                      <div className="grid gap-3 md:grid-cols-3">
                        <select
                          ...
                          className="rounded-2xl border border-[var(--line)] bg-white/85 px-4 py-3 disabled:opacity-50"
                        >
                          {tool.plans.map((plan) => (
            ...
            <button
              ...
              disabled={loading}
              className="mt-7 inline-flex w-full items-center justify-center rounded-full bg-[#102229] px-6 py-4 text-base font-semibold text-[#fff7ef] transition hover:translate-y-[-1px] disabled:opacity-60"
            >
          ...
          <section className="glass rounded-[36px] border border-[var(--line)] p-6 md:p-8">
            ...
            {!report ? (
              <div className="mt-10 rounded-[30px] border border-dashed border-[var(--line-strong)] px-6 py-16 text-center text-[var(--ink-soft)]">
              ...
              <div className="mt-7 space-y-5">
                <div className="rounded-[30px] bg-[#102229] p-6 text-[#fff7ef]">
                  <div className="flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
                    <div>
                      ...
                      <h3 className="mt-3 text-5xl font-semibold tracking-[-0.05em]">
                    ...
                    <div className="rounded-[24px] bg-[#17343d] px-5 py-4">
                ...
                <div className="rounded-[28px] border border-[var(--line)] bg-[var(--card-strong)] p-5">
                  <p className="font-mono text-xs uppercase tracking-[0.22em] text-[var(--ink-soft)]">
                    Shareable report
                  </p>
                ...
                <form
                  ...
                  className="rounded-[30px] border border-[var(--line)] bg-[rgba(255,255,255,0.75)] p-6"
                >
                  ...
                  <button
                    ...
                    className="mt-5 inline-flex items-center justify-center rounded-full bg-[var(--mint-deep)] px-5 py-3 font-semibold text-white"
                  >
                    {leadState === "saving" ? "Sending..." : "Email me this audit"}
                  </button>

                  {leadState === "saved" ? (
                    <p className="mt-3 text-sm text-[var(--mint-deep)]">
...
function MetricCard({
  ...
  return (
    <div className="rounded-[26px] border border-[var(--line)] bg-[var(--card-strong)] p-5">
      ...
      <p className="mt-2 text-sm text-[var(--ink-soft)]">{note}</p>
    </div>
  );
}
